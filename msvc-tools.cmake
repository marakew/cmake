...
set(CMAKE_C_FLAGS_DEBUG "${_FLAGS_DEBUG} ${_FLAGS_C}" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELEASE "/O2 ${_FLAGS_C}" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELWITHDEBINFO "${_FLAGS_DEBUG} /O2 ${_FLAGS_C}" CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_MINSIZEREL "/O1 ${_FLAGS_C}" CACHE STRING "" FORCE)

set(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_DEBUG "${_FLAGS_DEBUG} ${_FLAGS_CXX}" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_RELEASE "/O2 ${_FLAGS_CXX}" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${_FLAGS_DEBUG} /O2 ${_FLAGS_CXX}" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_MINSIZEREL "/O1 ${_FLAGS_CXX}" CACHE STRING "" FORCE)
